...
#include "gc2365submipi_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "GC2365SUB_camera_sensor"
#define LOG_1 LOG_INF("GC2365SUB,MIPI 2LANE\n")
/****************************   Modify end    *******************************************/
#define DEBUG 1
...
kal_bool GC2365SUBDuringTestPattern = KAL_FALSE;

static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC2365SUBMIPI_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x02,0x7f);//77
	write_cmos_sensor(0x03,0x97);//97
...
static kal_uint32 open(void)
{
    ...
    spin_unlock(&imgsensor_drv_lock);
    GC2365SUBDuringTestPattern = KAL_FALSE; 
...
UINT32 GC2365SUBMIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    GC2365SUBMIPI_RAW_SensorInit    */
