...
static void GC2145_Sensor_Init(void)
{
	...
	GC2145_write_cmos_sensor(0x17 , 0x17); //mirror 14
	...
	GC2145_write_cmos_sensor(0x22 , 0xa0); 
	...
	GC2145_write_cmos_sensor(0x85 , 0x08); 
	...
	GC2145_write_cmos_sensor(0x43 , 0x5b); 
	...
	GC2145_write_cmos_sensor(0x6a , 0x08); 
	GC2145_write_cmos_sensor(0x6b , 0x08); 
	GC2145_write_cmos_sensor(0x6c , 0x08); 
	GC2145_write_cmos_sensor(0x6d , 0x08); 
	GC2145_write_cmos_sensor(0x6e , 0x08); 
	GC2145_write_cmos_sensor(0x6f , 0x08); 
	GC2145_write_cmos_sensor(0x70 , 0x08); 
	GC2145_write_cmos_sensor(0x71 , 0x08);   
	GC2145_write_cmos_sensor(0x76 , 0x00);
	...
	GC2145_write_cmos_sensor(0x89 , 0xb0);
	...
	GC2145_write_cmos_sensor(0xb7 , 0x01);
	GC2145_write_cmos_sensor(0xb9 , 0x2b);
	GC2145_write_cmos_sensor(0x3c , 0x04);
	GC2145_write_cmos_sensor(0x3d , 0x15);
	GC2145_write_cmos_sensor(0x4b , 0x06);
	...
	GC2145_write_cmos_sensor(0xed , 0x80);
	GC2145_write_cmos_sensor(0xee , 0x00);
	...
	//////////////////////////////////////////
	GC2145_write_cmos_sensor(0xfe , 0x01);
	GC2145_write_cmos_sensor(0xc2 , 0x14);
	GC2145_write_cmos_sensor(0xc3 , 0x0d);
	GC2145_write_cmos_sensor(0xc4 , 0x0c);
	GC2145_write_cmos_sensor(0xc8 , 0x15);
	GC2145_write_cmos_sensor(0xc9 , 0x0d);
	GC2145_write_cmos_sensor(0xca , 0x0a);
	GC2145_write_cmos_sensor(0xbc , 0x24);
	GC2145_write_cmos_sensor(0xbd , 0x10);
	GC2145_write_cmos_sensor(0xbe , 0x0b);
	GC2145_write_cmos_sensor(0xb6 , 0x25);
	GC2145_write_cmos_sensor(0xb7 , 0x16);
	GC2145_write_cmos_sensor(0xb8 , 0x15);
	GC2145_write_cmos_sensor(0xc5 , 0x00);
	GC2145_write_cmos_sensor(0xc6 , 0x00);
	GC2145_write_cmos_sensor(0xc7 , 0x00);
	GC2145_write_cmos_sensor(0xcb , 0x00);
	GC2145_write_cmos_sensor(0xcc , 0x00);
	GC2145_write_cmos_sensor(0xcd , 0x00);
	GC2145_write_cmos_sensor(0xbf , 0x07);
	GC2145_write_cmos_sensor(0xc0 , 0x00);
	GC2145_write_cmos_sensor(0xc1 , 0x00);
	GC2145_write_cmos_sensor(0xb9 , 0x00);
	GC2145_write_cmos_sensor(0xba , 0x00);
	GC2145_write_cmos_sensor(0xbb , 0x00);
	GC2145_write_cmos_sensor(0xaa , 0x01);
	GC2145_write_cmos_sensor(0xab , 0x01);
	GC2145_write_cmos_sensor(0xac , 0x00);
	GC2145_write_cmos_sensor(0xad , 0x05);
	GC2145_write_cmos_sensor(0xae , 0x06);
	GC2145_write_cmos_sensor(0xaf , 0x0e);
	GC2145_write_cmos_sensor(0xb0 , 0x0b);
	GC2145_write_cmos_sensor(0xb1 , 0x07);
	GC2145_write_cmos_sensor(0xb2 , 0x06);
	GC2145_write_cmos_sensor(0xb3 , 0x17);
	GC2145_write_cmos_sensor(0xb4 , 0x0e);
	GC2145_write_cmos_sensor(0xb5 , 0x0e);
	GC2145_write_cmos_sensor(0xd0 , 0x09);
	GC2145_write_cmos_sensor(0xd1 , 0x00);
	GC2145_write_cmos_sensor(0xd2 , 0x00);
	GC2145_write_cmos_sensor(0xd6 , 0x08);
	GC2145_write_cmos_sensor(0xd7 , 0x00);
	GC2145_write_cmos_sensor(0xd8 , 0x00);
	GC2145_write_cmos_sensor(0xd9 , 0x00);
	GC2145_write_cmos_sensor(0xda , 0x00);
	GC2145_write_cmos_sensor(0xdb , 0x00);
	GC2145_write_cmos_sensor(0xd3 , 0x0a);
	GC2145_write_cmos_sensor(0xd4 , 0x00);
	GC2145_write_cmos_sensor(0xd5 , 0x00);
	...
	GC2145_write_cmos_sensor(0x4e , 0x03);
	GC2145_write_cmos_sensor(0x4c , 0x01);
	GC2145_write_cmos_sensor(0x4d , 0x4d);
	GC2145_write_cmos_sensor(0x4e , 0x03);
	GC2145_write_cmos_sensor(0x4c , 0x01);
	...
	GC2145_write_cmos_sensor(0x4e , 0x03);
	GC2145_write_cmos_sensor(0x4c , 0x01);
	GC2145_write_cmos_sensor(0x4d , 0x4c);
	GC2145_write_cmos_sensor(0x4e , 0x03);
	GC2145_write_cmos_sensor(0x4c , 0x01);
	...
	GC2145_write_cmos_sensor(0x4e , 0x04);                            
	GC2145_write_cmos_sensor(0x4c , 0x02);//tl84
	...
	GC2145_write_cmos_sensor(0x4e , 0x06); 
	GC2145_write_cmos_sensor(0x4c , 0x02);
	GC2145_write_cmos_sensor(0x4d , 0x48);
	GC2145_write_cmos_sensor(0x4e , 0x06);
	GC2145_write_cmos_sensor(0x4c , 0x02);
	...
	GC2145_write_cmos_sensor(0x4e , 0x07);
	GC2145_write_cmos_sensor(0x4c , 0x03);
	GC2145_write_cmos_sensor(0x4d , 0x09);
	GC2145_write_cmos_sensor(0x4e , 0x07);
	GC2145_write_cmos_sensor(0x4c , 0x02);
	...
	GC2145_write_cmos_sensor(0x4e , 0x07);
	GC2145_write_cmos_sensor(0x4c , 0x02);
	GC2145_write_cmos_sensor(0x4d , 0xe8);
	GC2145_write_cmos_sensor(0x4e , 0x07);
	GC2145_write_cmos_sensor(0x4c , 0x02);
	GC2145_write_cmos_sensor(0x4d , 0xa7);
	GC2145_write_cmos_sensor(0x4e , 0x07);
	GC2145_write_cmos_sensor(0x4c , 0x02);
	GC2145_write_cmos_sensor(0x4d , 0xc7);
	GC2145_write_cmos_sensor(0x4e , 0x07);
	GC2145_write_cmos_sensor(0x4c , 0x02);
	GC2145_write_cmos_sensor(0x4d , 0xe7);
	GC2145_write_cmos_sensor(0x4e , 0x07);
	GC2145_write_cmos_sensor(0x4c , 0x03);
	GC2145_write_cmos_sensor(0x4d , 0x07);
	GC2145_write_cmos_sensor(0x4e , 0x07);
	...
	GC2145_write_cmos_sensor(0x71 , 0x60);
	GC2145_write_cmos_sensor(0x72 , 0x80);
	...
	GC2145_write_cmos_sensor(0x7b , 0x58);
	GC2145_write_cmos_sensor(0xfe , 0x00);
	//////////////////////////////////////////
	///////////CC////////////////////////
	//////////////////////////////////////////
	...
	GC2145_write_cmos_sensor(0xc1 , 0x44);
	GC2145_write_cmos_sensor(0xc2 , 0xfd);
	GC2145_write_cmos_sensor(0xc3 , 0x04);
	GC2145_write_cmos_sensor(0xc4 , 0xF0);
	GC2145_write_cmos_sensor(0xc5 , 0x48);
	GC2145_write_cmos_sensor(0xc6 , 0xfd);
	GC2145_write_cmos_sensor(0xc7 , 0x46);
	GC2145_write_cmos_sensor(0xc8 , 0xfd);
	GC2145_write_cmos_sensor(0xc9 , 0x02);
...
static void GC2145_Sensor_SVGA(void)
{
	...
	GC2145_write_cmos_sensor(0xfe, 0x02);
	GC2145_write_cmos_sensor(0x9d, 0x08);
	GC2145_write_cmos_sensor(0xfe, 0x01);
...
static void GC2145_Sensor_2M(void)
{
	...
	GC2145_write_cmos_sensor(0xfe , 0x00);
	GC2145_write_cmos_sensor(0x20 , 0x15);
	GC2145_write_cmos_sensor(0xfe , 0x00);
...
UINT32 GC2145Capture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    volatile kal_uint32 shutter = GC2145_exposure_lines;
