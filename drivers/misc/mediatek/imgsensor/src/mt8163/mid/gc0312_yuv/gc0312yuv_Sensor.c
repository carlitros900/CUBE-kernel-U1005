...
#define GC0312_TEST_PATTERN_CHECKSUM 0x4e908d1c
...
static u8 GC0312_Initialize_from_T_Flash()
{
	...
	for (j=0; j<i; j++)
	{
		...
		{
			GC0312_write_cmos_sensor(gc0312_Init_Reg[j].init_reg, gc0312_Init_Reg[j].init_val);
...
void GC0312_Sensor_Init(void)
{
	...
	GC0312_write_cmos_sensor(0x20, 0x8b);//0x89 travis20140801
...
/* 
	GC0312_write_cmos_sensor(0xfe, 0x00);//big gamma
	GC0312_write_cmos_sensor(0xbf, 0x08);
	GC0312_write_cmos_sensor(0xc0, 0x1d);
	GC0312_write_cmos_sensor(0xc1, 0x34);
	GC0312_write_cmos_sensor(0xc2, 0x4b);
	GC0312_write_cmos_sensor(0xc3, 0x60);
	GC0312_write_cmos_sensor(0xc4, 0x73);
	GC0312_write_cmos_sensor(0xc5, 0x85);
	GC0312_write_cmos_sensor(0xc6, 0x9f);
	GC0312_write_cmos_sensor(0xc7, 0xb5);
	GC0312_write_cmos_sensor(0xc8, 0xc7);
	GC0312_write_cmos_sensor(0xc9, 0xd5);
	GC0312_write_cmos_sensor(0xca, 0xe0);
	GC0312_write_cmos_sensor(0xcb, 0xe7);
	GC0312_write_cmos_sensor(0xcc, 0xec);
	GC0312_write_cmos_sensor(0xcd, 0xf4);
	GC0312_write_cmos_sensor(0xce, 0xfa);
	GC0312_write_cmos_sensor(0xcf, 0xff);
*/	

/*
	GC0312_write_cmos_sensor(0xfe, 0x00);//small gamma
	GC0312_write_cmos_sensor(0xbf, 0x08);
	GC0312_write_cmos_sensor(0xc0, 0x18);
	GC0312_write_cmos_sensor(0xc1, 0x2c);
	GC0312_write_cmos_sensor(0xc2, 0x41);
	GC0312_write_cmos_sensor(0xc3, 0x59);
	GC0312_write_cmos_sensor(0xc4, 0x6e);
	GC0312_write_cmos_sensor(0xc5, 0x81);
	GC0312_write_cmos_sensor(0xc6, 0x9f);
	GC0312_write_cmos_sensor(0xc7, 0xb5);
	GC0312_write_cmos_sensor(0xc8, 0xc7);
	GC0312_write_cmos_sensor(0xc9, 0xd5);
...
*/
	...
	GC0312_write_cmos_sensor(0x6a, 0x25);
	...
	GC0312_write_cmos_sensor(0xd0, 0x28);//skin red
	GC0312_write_cmos_sensor(0xd1, 0x00);
	GC0312_write_cmos_sensor(0xd2, 0x02);
	GC0312_write_cmos_sensor(0xd3, 0x04);
	GC0312_write_cmos_sensor(0xd4, 0x38);
	GC0312_write_cmos_sensor(0xd5, 0x12);	
/*                     
...
BOOL GC0312_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_10:			
			GC0312_write_cmos_sensor(0xfe, 0x01);
			GC0312_write_cmos_sensor(0x13, 0x55);
			GC0312_write_cmos_sensor(0xfe, 0x00);
		break;
		
		case AE_EV_COMP_20:
			GC0312_write_cmos_sensor(0xfe, 0x01);
			GC0312_write_cmos_sensor(0x13, 0x68);
			GC0312_write_cmos_sensor(0xfe, 0x00);
		break;
		case AE_EV_COMP_30:
			GC0312_write_cmos_sensor(0xfe, 0x01);
			GC0312_write_cmos_sensor(0x13, 0x70);
			GC0312_write_cmos_sensor(0xfe, 0x00);
		break;
		default:
		return FALSE;
