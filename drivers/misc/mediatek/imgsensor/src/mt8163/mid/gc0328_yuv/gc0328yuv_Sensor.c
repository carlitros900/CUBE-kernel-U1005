...
void  GC0328_write_cmos_sensor(kal_uint8 addr, kal_uint8 para)
{
...
void GC0328_Sensor_Init(void)
{
	...
	GC0328_write_cmos_sensor(0x17 , 0x14);    
	...
	GC0328_write_cmos_sensor(0x23 , 0x04);    
	GC0328_write_cmos_sensor(0x24 , 0x13);  //0x16  0x13 0x1a 0x1f 0x3f
	...
	GC0328_write_cmos_sensor(0x22 , 0x50);   
	...
	GC0328_SET_PAGE0;
	GC0328_write_cmos_sensor(0x05, 0x01); 	
	GC0328_write_cmos_sensor(0x06, 0x32); 
	GC0328_write_cmos_sensor(0x07, 0x00);
	GC0328_write_cmos_sensor(0x08, 0x70);

	GC0328_SET_PAGE1;
	GC0328_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
	GC0328_write_cmos_sensor(0x2a, 0x3c);   //anti-flicker step [7:0]

	GC0328_write_cmos_sensor(0x2b, 0x02);   //exp level 0  14.28fps
	GC0328_write_cmos_sensor(0x2c, 0x58); 
	GC0328_write_cmos_sensor(0x2d, 0x02);   //exp level 1  12.50fps
	GC0328_write_cmos_sensor(0x2e, 0x58); 
	GC0328_write_cmos_sensor(0x2f, 0x02);   //exp level 2  10.00fps
	GC0328_write_cmos_sensor(0x30, 0xd0); 
	GC0328_write_cmos_sensor(0x31, 0x03);   //exp level 3  7.14fps
	GC0328_write_cmos_sensor(0x32, 0x84); 
	GC0328_SET_PAGE0;
...
UINT32 GC0328GetSensorID(UINT32 *sensorID)
{
    ...
    do
    {
        ...
        for(i = 0; i < 3; i++)
		{
			...
			{
                printk("GC0328  Read Sensor ID Fail = 0x%04x\n", sensor_id);
	            break;
	        }
        }
        	mdelay(50);
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
        pSensorInfo->SensorClockFreq=12;// 24
...
BOOL GC0328_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0328_write_cmos_sensor(0x06, 0x32); 
			GC0328_write_cmos_sensor(0x07, 0x00);
			GC0328_write_cmos_sensor(0x08, 0x3e);
			
			GC0328_SET_PAGE1;
			GC0328_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
			GC0328_write_cmos_sensor(0x2a, 0x32);   //anti-flicker step [7:0]
			
			GC0328_write_cmos_sensor(0x2b, 0x02);   //exp level 0  14.28fps
			GC0328_write_cmos_sensor(0x2c, 0x26); 
			GC0328_write_cmos_sensor(0x2d, 0x02);   //exp level 1  12.50fps
			GC0328_write_cmos_sensor(0x2e, 0x26); 
			GC0328_write_cmos_sensor(0x2f, 0x02);   //exp level 2  10.00fps
			GC0328_write_cmos_sensor(0x30, 0xbc); 
			GC0328_write_cmos_sensor(0x31, 0x03);   //exp level 3  7.14fps
			GC0328_write_cmos_sensor(0x32, 0x20); 
			GC0328_write_cmos_sensor(0x33, 0x30); 
			GC0328_SET_PAGE0;
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_10:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0xa8);
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
