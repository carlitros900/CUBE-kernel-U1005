...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC2355_DVP_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
static kal_uint32 return_sensor_id(void)
{
	...
	sensor_id = ((read_cmos_sensor(0xf0) << 8) | read_cmos_sensor(0xf1)) + 1; // tongjun@MID add
	return sensor_id;
}
static void set_max_framerate(UINT16 framerate, kal_bool min_framelength_en)
{
	...
	LOG_INF("framerate = %d, min framelength should enable? : %s\n", framerate, min_framelength_en ? "yes" : "no");
