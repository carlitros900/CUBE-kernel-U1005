	...
	do {
		*sensorID = ((GC2035_read_cmos_sensor(0xf0) << 8) | GC2035_read_cmos_sensor(0xf1));
		if (*sensorID == GC2035_SENSOR_ID) {
			SENSORDB("GC2035 Read Sensor ID succesfully = 0x%04x\n", *sensorID);
			break;
		}
		SENSORDB("GC2035 Read Sensor ID Fail = 0x%04x\n", *sensorID);
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x04 , 0xa8);
	...
	GC2035_write_cmos_sensor(0x22 , 0xf0); //[3:0]vref  d0 20130628
	...
	GC2035_write_cmos_sensor(0x06 , 0x23);
	GC2035_write_cmos_sensor(0x07 , 0x00);
	GC2035_write_cmos_sensor(0x08 , 0x14);
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0x27 , 0x00);
	GC2035_write_cmos_sensor(0x28 , 0xaa);
	GC2035_write_cmos_sensor(0x29 , 0x04);//  level 0 13.75
	GC2035_write_cmos_sensor(0x2a , 0xa6);
	GC2035_write_cmos_sensor(0x2b , 0x04);//  level 1 13.75
	GC2035_write_cmos_sensor(0x2c , 0xa6);
	GC2035_write_cmos_sensor(0x2d , 0x06);//  level 2 10
	GC2035_write_cmos_sensor(0x2e , 0xa4);
	GC2035_write_cmos_sensor(0x2f , 0x08);//  level 3 7.5
	GC2035_write_cmos_sensor(0x30 , 0xa2);
	GC2035_write_cmos_sensor(0xfe , 0x00);//
	...
	GC2035_write_cmos_sensor(0x81 , 0x26);//38 //skin_Y 8c_debug
	GC2035_write_cmos_sensor(0x87 , 0x90);//[7]middle gamma
	GC2035_write_cmos_sensor(0x84 , 0x03);//output put foramat
	GC2035_write_cmos_sensor(0x86 , 0x06);//02 //sync plority  lanking
	...
	GC2035_write_cmos_sensor(0xb0 , 0x99);//edge effect slope low
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x38);//saturation_cb
	GC2035_write_cmos_sensor(0xd2 , 0x38);//saturation_Cr
...
static void GC2035_Sensor_SVGA(void)
{
	...
	GC2035_write_cmos_sensor(0x9a , 0x07);
...
BOOL GC2035_set_param_banding(UINT16 para)
{
	...
	case AE_FLICKER_MODE_60HZ:
		...
		GC2035_write_cmos_sensor(0xfe, 0x00);
		GC2035_write_cmos_sensor(0x05, 0x01);
		GC2035_write_cmos_sensor(0x06, 0x39);
		GC2035_write_cmos_sensor(0x07, 0x00);
		GC2035_write_cmos_sensor(0x08, 0x14);
		GC2035_write_cmos_sensor(0xfe, 0x01);
		GC2035_write_cmos_sensor(0x27, 0x00);
		GC2035_write_cmos_sensor(0x28, 0x8b);
		GC2035_write_cmos_sensor(0x29, 0x04);
		GC2035_write_cmos_sensor(0x2a, 0x58);
		GC2035_write_cmos_sensor(0x2b, 0x04);
		GC2035_write_cmos_sensor(0x2c, 0x58);
		GC2035_write_cmos_sensor(0x2d, 0x06);
		GC2035_write_cmos_sensor(0x2e, 0x84);
		GC2035_write_cmos_sensor(0x2f, 0x08);
		GC2035_write_cmos_sensor(0x30, 0xb0);
		GC2035_write_cmos_sensor(0xfe, 0x00);
		break;
                            ...
                            UINT8 *pFeaturePara, UINT32 *pFeatureParaLen)
{
	...
	case SENSOR_FEATURE_SET_YUV_CMD:
		...
		GC2035YUVSensorSetting((FEATURE_ID)*feature_data, *(feature_data+1));
		break;
