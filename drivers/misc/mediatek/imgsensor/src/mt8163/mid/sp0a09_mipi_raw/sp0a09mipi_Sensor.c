...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = SP0A09MIPI_SENSOR_ID,
...
{{  648, 488,  4, 4, 640, 480, 640, 480, 0, 0, 640, 480,  0, 0, 640, 480}, // Preview 2112*1558                          
  {  648, 488,  4, 4, 640, 480, 640, 480, 0, 0, 640, 480,  0, 0, 640, 480}, // capture 4206*3128                          
  {  648, 488,  4, 4, 640, 480, 640, 480, 0, 0, 640, 480,  0, 0, 640, 480}, // video                                      
  {  648, 488,  4, 4, 640, 480, 640, 480, 0, 0, 640, 480,  0, 0, 640, 480}, //hight speed video                           
  {  648, 488,  4, 4, 640, 480, 640, 480, 0, 0, 640, 480,  0, 0, 640, 480},}; // slim video
...
static void sensor_init(void)
{
  ...
  /*
  write_cmos_sensor(0xfd,0x00);
  write_cmos_sensor(0x0b,0x2b);
  write_cmos_sensor(0x0c,0x00);
  write_cmos_sensor(0x1d,0x00);
  write_cmos_sensor(0x0f,0x2f);
  write_cmos_sensor(0x10,0xc0);
  write_cmos_sensor(0x11,0x30);
  write_cmos_sensor(0x13,0x10);
  write_cmos_sensor(0x6c,0x11);
  write_cmos_sensor(0x6d,0x00);
  write_cmos_sensor(0x6f,0x00);
  write_cmos_sensor(0x6e,0x12);
  write_cmos_sensor(0x69,0x87);
  write_cmos_sensor(0x71,0x85);
  write_cmos_sensor(0x14,0x01);
  write_cmos_sensor(0x15,0x84);
  write_cmos_sensor(0x16,0x26);
  write_cmos_sensor(0x17,0x26);
  write_cmos_sensor(0x70,0x39);
  write_cmos_sensor(0x6a,0x18);
  write_cmos_sensor(0x72,0x1a);
  write_cmos_sensor(0x1a,0x19);
  write_cmos_sensor(0x1e,0x0b);  
  write_cmos_sensor(0x21,0x46);
  write_cmos_sensor(0x22,0x35);
  write_cmos_sensor(0x27,0xbb);
  write_cmos_sensor(0x28,0x7f);
  write_cmos_sensor(0x1b,0x0f);
  write_cmos_sensor(0x03,0x00);
  write_cmos_sensor(0x04,0x85); 
  write_cmos_sensor(0x09,0x00);//00
  write_cmos_sensor(0x0a,0x60);
  write_cmos_sensor(0x01,0x01);
  write_cmos_sensor(0x24,0xc0);
  write_cmos_sensor(0x01,0x01);
  write_cmos_sensor(0xfd,0x00);
  write_cmos_sensor(0x01,0x01);
  write_cmos_sensor(0x98,0x2b);
  write_cmos_sensor(0x9d,0x85);
  ...
  write_cmos_sensor(0x27,0xfb); //9b 
