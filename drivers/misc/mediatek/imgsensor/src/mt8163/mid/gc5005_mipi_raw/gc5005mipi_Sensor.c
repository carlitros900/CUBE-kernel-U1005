...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC5005MIPI_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
static void set_dummy(void)
{
	...
	vb = imgsensor.dummy_line + Basic_Dummy_Line;//1229	
...
//  end	
	...
	LOG_INF("--0103--vb = %d \n", vb);
 LOG_INF("--0103--Exit! 0x07 =0x%x, 0x08 =0x%x \n", read_cmos_sensor(0x07),read_cmos_sensor(0x08));
}    /*    set_dummy  */
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x02, 0x77);  //0x55 0x33  mipi drive capacity
	write_cmos_sensor(0x03, 0x95);  // 0x93
