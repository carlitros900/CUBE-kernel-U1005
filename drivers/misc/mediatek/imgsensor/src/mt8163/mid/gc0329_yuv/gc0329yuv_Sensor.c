...
void GC0329NightMode(kal_bool bEnable)
{
	...
	else 
	{
		...
		if(GC0329_MPEG4_encode_mode == KAL_TRUE)
			...
			GC0329_write_cmos_sensor(0x33, 0x20);
		GC0329_write_cmos_sensor(0xfe, 0x00);
		GC0329GammaSelect(GC0329_RGB_Gamma_m5);
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0xfc , 0x16);
	GC0329_write_cmos_sensor(0xfe , 0x00);
	//GC0329_write_cmos_sensor(0xfa , 0x11);
	...
	////////////////////blk////////////////////
	GC0329_write_cmos_sensor(0x26 , 0xf4); //BLK
	GC0329_write_cmos_sensor(0x2a , 0x2c); 
	GC0329_write_cmos_sensor(0x2b , 0x2c); 
	GC0329_write_cmos_sensor(0x2c , 0x2c); 
	GC0329_write_cmos_sensor(0x2d , 0x2c); 
	...
	GC0329_write_cmos_sensor(0xd3 , 0x3c); //cont 0x40
	...
	GC0329_write_cmos_sensor(0x06 , 0x0a); 
	GC0329_write_cmos_sensor(0x07 , 0x00);
	GC0329_write_cmos_sensor(0x08 , 0x70);
	GC0329_write_cmos_sensor(0xfe , 0x01); 
	GC0329_write_cmos_sensor(0x29 , 0x00);  //anti-flicker step [11:8]
	GC0329_write_cmos_sensor(0x2a , 0x7d);  //anti-flicker step [7:0]
	GC0329_write_cmos_sensor(0x2b , 0x02);  //exp level 0 , 0x14.28fps
	GC0329_write_cmos_sensor(0x2c , 0x58); 
	GC0329_write_cmos_sensor(0x2d , 0x03);  //exp level 1 , 0x12.50fps
	GC0329_write_cmos_sensor(0x2e , 0x84); 
	GC0329_write_cmos_sensor(0x2f , 0x04);  //exp level 2 , 0x10.00fps
	GC0329_write_cmos_sensor(0x30 , 0xb0); 
	GC0329_write_cmos_sensor(0x31 , 0x05);  //exp level 3 , 0x7.14fps
	GC0329_write_cmos_sensor(0x32 , 0x40); 
	GC0329_write_cmos_sensor(0xfe , 0x00); 
	#endif
