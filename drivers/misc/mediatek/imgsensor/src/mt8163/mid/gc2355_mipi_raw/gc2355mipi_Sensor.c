...
#define DEBUG 1
//#define GC2355MIPI_2Lane   //   for  mipi lane num, tong@mid for K71 front camera phisical 1 lane 
/****************************Modify Following Strings for Debug****************************/
#define PFX "GC2355mipi_camera_sensor"
#define LOG_1 LOG_INF("GC2355,MIPI 1LANE\n")   //tong@mid
