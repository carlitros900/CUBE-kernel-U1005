...
static imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        ...
        .linelength = 1395,            //record different mode's linelength
    ...
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_R,//lyq SENSOR_OUTPUT_FORMAT_RAW_B,//sensor output first pixel color
...
static void sensor_init(void)
{
      ...
      write_cmos_sensor(0xfb,0x73);//9.29canshu 63
			...
			write_cmos_sensor(0xa0,0x29);//05,20151231
			...
			//lyq
	        write_cmos_sensor(0xfd ,0x01);
	        write_cmos_sensor(0x3f ,0x03); //mirror
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                printk("sp2509_get_imgsensor_id: 0x%x\n", *sensor_id);
                return ERROR_NONE;
            }
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
    ...
    if(enable)
        write_cmos_sensor0(0x503D, 0x80);
    else
        write_cmos_sensor0(0x503D, 0x00);
