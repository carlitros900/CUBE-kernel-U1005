...
{
    kal_uint8 i = 0;
    kal_uint8 Reg_Cgain=0,Reg_Dgain=0;
...
// Full Frame Dark Shading Setting
    write_cmos_sensor(0xFBD7, 0x4C); // FF_SUB_G1 HI
    write_cmos_sensor(0xFBD8, 0x89); // FF_SUB_G1 LO
    write_cmos_sensor(0xFBD9, 0x44); // FF_DIV_G1 HI
    write_cmos_sensor(0xFBDA, 0xED); // FF_DIV_G1 LO
    write_cmos_sensor(0xFBDB, 0x4C); // FF_SUB_G2 HI
    write_cmos_sensor(0xFBDC, 0x6C); // FF_SUB_G2 LO
    write_cmos_sensor(0xFBDD, 0x44); // FF_DIV_G2 HI
    write_cmos_sensor(0xFBDE, 0xDA); // FF_DIV_G2 LO
    write_cmos_sensor(0xFBDF, 0x4C); // FF_SUB_G4 HI
    write_cmos_sensor(0xFBE0, 0x5F); // FF_SUB_G4 LO
    write_cmos_sensor(0xFBE1, 0x44); // FF_DIV_G4 HI
    write_cmos_sensor(0xFBE2, 0xE0); // FF_DIV_G4 LO
    write_cmos_sensor(0xFBE3, 0x4C); // FF_SUB_G8 HI
    write_cmos_sensor(0xFBE4, 0x59); // FF_SUB_G8 LO
    write_cmos_sensor(0xFBE5, 0x44); // FF_DIV_G8 HI
    write_cmos_sensor(0xFBE6, 0xE1); // FF_DIV_G8 LO
    write_cmos_sensor(0xFBE7, 0x4C); // FF_SUB_G16 HI
    write_cmos_sensor(0xFBE8, 0x4F); // FF_SUB_G16 LO
    write_cmos_sensor(0xFBE9, 0x44); // FF_DIV_G16 HI
    write_cmos_sensor(0xFBEA, 0xE6); // FF_DIV_G16 LO
    // Analogue Binning 2x2 Dark Shading Setting
    write_cmos_sensor(0xFBEB, 0x00); // AB_SUB_G1 HI
    write_cmos_sensor(0xFBEC, 0x00); // AB_SUB_G1 LO
    write_cmos_sensor(0xFBED, 0x00); // AB_DIV_G1 HI
    write_cmos_sensor(0xFBEE, 0x00); // AB_DIV_G1 LO
    write_cmos_sensor(0xFBEF, 0x00); // AB_SUB_G2 HI
    write_cmos_sensor(0xFBF0, 0x00); // AB_SUB_G2 LO
    write_cmos_sensor(0xFBF1, 0x00); // AB_DIV_G2 HI
    write_cmos_sensor(0xFBF2, 0x00); // AB_DIV_G2 LO
    write_cmos_sensor(0xFBF3, 0x00); // AB_SUB_G4 HI
    write_cmos_sensor(0xFBF4, 0x00); // AB_SUB_G4 LO
    write_cmos_sensor(0xFBF5, 0x00); // AB_DIV_G4 HI
    write_cmos_sensor(0xFBF6, 0x00); // AB_DIV_G4 LO
    write_cmos_sensor(0xFBF7, 0x00); // AB_SUB_G8 HI
    write_cmos_sensor(0xFBF8, 0x00); // AB_SUB_G8 LO
    write_cmos_sensor(0xFBF9, 0x00); // AB_DIV_G8 HI
    write_cmos_sensor(0xFBFA, 0x00); // AB_DIV_G8 LO
    write_cmos_sensor(0xFBFB, 0x00); // AB_SUB_G16 HI
    write_cmos_sensor(0xFBFC, 0x00); // AB_SUB_G16 LO
    write_cmos_sensor(0xFBFD, 0x00); // AB_DIV_G16 HI
    write_cmos_sensor(0xFBFE, 0x00); // AB_DIV_G16 LO
	...
	kal_uint8 retry = 3;
		do {
			*sensor_id = ((read_cmos_sensor(0x2016) << 8) | read_cmos_sensor(0x2017));
			//LOG_INF("hm5040_get_imgsensor_id: 0x%x\n", *sensor_id);
...
static kal_uint32 open(void)
{
	...
	//kal_uint8 retry = 3;
		do {
			sensor_id = (kal_uint16)((read_cmos_sensor(0x2016) << 8) | read_cmos_sensor(0x2017));
