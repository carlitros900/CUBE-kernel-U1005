...
//zqf  2015-10-10 modify #define GC0310MIPI_TEST_PATTERN_CHECKSUM 0x4e908d1c

#define GC0310MIPI_TEST_PATTERN_CHECKSUM  0x6290e90f 
...
void GC0310MIPI_Sensor_Init(void)
{
  ...
  /////////////////////////////////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0x95,0x32); //65
...
*/
	...
	GC0310MIPI_write_cmos_sensor(0xd1,0x26); // 2c
	GC0310MIPI_write_cmos_sensor(0xd2,0x26); // 2c
	...
	GC0310MIPI_write_cmos_sensor(0xa9,0xbc); 
	GC0310MIPI_write_cmos_sensor(0xaa,0x95); 
	...
	GC0310MIPI_write_cmos_sensor(0xd0,0x34);//skin red // 38
...
*/
	...
	GC0310MIPI_write_cmos_sensor(0x2b,0x05); //7.14fps
...

{
    ...
    image_window->ExposureWindowWidth = GC0310MIPI_IMAGE_SENSOR_PV_WIDTH;
    image_window->ExposureWindowHeight =GC0310MIPI_IMAGE_SENSOR_PV_HEIGHT;
...

{
    ...
    image_window->GrabStartX = IMAGE_SENSOR_VGA_GRAB_PIXELS;
    image_window->GrabStartY = IMAGE_SENSOR_VGA_GRAB_LINES;
    image_window->ExposureWindowWidth= GC0310MIPI_IMAGE_SENSOR_FULL_WIDTH;
    image_window->ExposureWindowHeight = GC0310MIPI_IMAGE_SENSOR_FULL_HEIGHT;
...
UINT32 GC0310MIPIGetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
    ...
    pSensorResolution->SensorVideoWidth=GC0310MIPI_IMAGE_SENSOR_PV_WIDTH;
    pSensorResolution->SensorVideoHeight=GC0310MIPI_IMAGE_SENSOR_PV_HEIGHT;
    return ERROR_NONE;
...
{
    pSensorInfo->SensorPreviewResolutionX=GC0310MIPI_IMAGE_SENSOR_PV_WIDTH;
    pSensorInfo->SensorPreviewResolutionY=GC0310MIPI_IMAGE_SENSOR_PV_HEIGHT;
    pSensorInfo->SensorFullResolutionX=GC0310MIPI_IMAGE_SENSOR_FULL_WIDTH;
    pSensorInfo->SensorFullResolutionY=GC0310MIPI_IMAGE_SENSOR_FULL_HEIGHT;
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_GET_PERIOD:
			*pFeatureReturnPara16++=GC0310MIPI_IMAGE_SENSOR_PV_WIDTH;
			*pFeatureReturnPara16=GC0310MIPI_IMAGE_SENSOR_PV_HEIGHT;
			*pFeatureParaLen=4;
		break;
		...
		case SENSOR_FEATURE_SET_NIGHTMODE:
			GC0310MIPINightMode((BOOL) *feature_data);	//GC0310MIPI_night_mode((BOOL) *feature_data);
		break;
		...
		case SENSOR_FEATURE_GET_LENS_DRIVER_ID:
			...
			*pFeatureParaLen=4;
		break;
//		case SENSOR_FEATURE_CHECK_SENSOR_ID:		//case duplicated
//			 GC0310MIPI_GetSensorID(pFeatureData32);
//			 break;
