...
#include "gc2235submipi_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "GC2235SUB_camera_sensor"
#define LOG_1 LOG_INF("GC2235SUB,MIPI 2LANE\n")
#define LOG_2 LOG_INF("preview 1280*960@30fps,864Mbps/lane; video 1280*960@30fps,864Mbps/lane; capture 5M@30fps,864Mbps/lane\n")
/****************************   Modify end    *******************************************/

//#define  GC2235SUBMIPI_2Lane
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC2235SUBMIPI_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h

    .checksum_value = 0x9d1c9dad,        //checksum value for Camera Auto Test

    .pre = {
    #ifdef GC2235SUBMIPI_2Lane
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
	...
	switch (image_mirror)
	{
		...
		case IMAGE_V_MIRROR://IMAGE_V_MIRROR:
			write_cmos_sensor(0x17,0x16); //lyq
...
/////////////////////////////////////////////////////
	...
	write_cmos_sensor(0x17, 0x16);//14 //[0]mirror [1]flip   lyq
	...
	write_cmos_sensor(0x92, 0x02);//lyq
	write_cmos_sensor(0x94, 0x0b);//lyq
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                printk("lingyq i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
                return ERROR_NONE;
            }
            printk("lingyq Read sensor id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
            retry--;
        } while(retry > 0);
        i++;
        retry = 2;
...
UINT32 GC2235SUBMIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	GC2235SUBMIPI_RAW_SensorInit	*/
