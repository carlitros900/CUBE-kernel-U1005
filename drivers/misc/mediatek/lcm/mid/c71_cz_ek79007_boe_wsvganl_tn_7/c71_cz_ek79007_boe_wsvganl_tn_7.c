...
data_array[0] = 0x8B801500;
dsi_set_cmdq(data_array, 1, 1);
MDELAY(1);

data_array[0] = 0xC8811500;
dsi_set_cmdq(data_array, 1, 1);
MDELAY(1);

data_array[0] = 0xDC821500;
dsi_set_cmdq(data_array, 1, 1);
MDELAY(1);

data_array[0] = 0xFF831500;
dsi_set_cmdq(data_array, 1, 1);
MDELAY(1);

data_array[0] = 0xCA841500;
dsi_set_cmdq(data_array, 1, 1);
MDELAY(1);

data_array[0] = 0x7C851500;
dsi_set_cmdq(data_array, 1, 1);
MDELAY(1);

data_array[0] = 0xB9861500;
dsi_set_cmdq(data_array, 1, 1);
MDELAY(1);
//====================================================
...
printk(" ##########  %s \r\n",__func__);
    ...
    params->dsi.vertical_backporch                              = 23; //16;
    params->dsi.vertical_frontporch                             = 12; 
    params->dsi.vertical_active_line                            = FRAME_HEIGHT; 

    params->dsi.horizontal_sync_active                          = 10; //5;//6;
    params->dsi.horizontal_backporch                            = 160; //60; //80;
...
LCM_DRIVER c71_cz_ek79007_boe_wsvganl_tn_7_lcm_drv={
	.name				="c71_cz_ek79007_boe_wsvganl_tn_7",
