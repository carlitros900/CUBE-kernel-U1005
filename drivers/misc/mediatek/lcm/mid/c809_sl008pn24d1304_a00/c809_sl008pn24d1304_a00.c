...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.mode=SYNC_EVENT_VDO_MODE;    //SYNC_PULSE_VDO_MODE = 1,SYNC_EVENT_VDO_MODE = 2,BURST_VDO_MODE = 3
...
LCM_DRIVER c809_sl008pn24d1304_a00_lcm_drv={
	.name				="c809_sl008pn24d1304_a00",
