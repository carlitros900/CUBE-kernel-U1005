...
#if 1
#define PMIC_RG_VGP3_EN_MASK       0xff
#define PMIC_RG_VGP3_EN_SHIFT      0xff
#define PMIC_RG_VGP3_VOSEL_MASK    0xff
#define PMIC_RG_VGP3_VOSEL_SHIFT   0xff
#define PMIC_RG_VGP2_EN_MASK       0xff
#define PMIC_RG_VGP2_EN_SHIFT      0xff
#define PMIC_RG_VGP2_VOSEL_MASK    0xff                           
#define PMIC_RG_VGP2_VOSEL_SHIFT   0xff                           
#endif
typedef enum {
	PMIC_RG_VCDT_HV_EN,
} PMU_FLAGS_LIST_ENUM;
